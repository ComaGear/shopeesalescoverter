...
public class MeasContentHandler extends DefaultHandler{
   enum dataType {
        NUMBER, SSTINDEX,
    }

    private static final String ID = "Pos Data Item No";
    private static final String RELATIVE_ID = "Relative Key";
    private static final String MEASUREMENT = "Maesurement";
    private static final String UPDATE_RULE = "Update Rule";
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if ("row".equals(qName)) {
            if (readingRow > 0)
                if(meas.getRelativeId() != null) measList.add(meas);
            this.readingRow += 1;
            this.meas = null;
        }
    ...
    public MeasContentHandler(SharedStrings sharedStrings, StylesTable stylesTable,
            ArrayList<Meas> measList) {
